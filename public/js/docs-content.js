  ...
  window.DOCS_SECTIONS = [
    ...
    },
    {
      ...
      content: '<h4>Зачем нужен APK</h4>' +
        ...
        '<h4>Вход в настройки</h4>' +
        '<p>Долгое нажатие (около 5 секунд) на экране плеера → ввод PIN (по умолчанию 1234) → открывается экран настроек для смены URL, screenId или PIN.</p>'
    },
    {
      id: 'pairing',
