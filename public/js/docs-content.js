  ...
  window.DOCS_SECTIONS = [
    ...
    },
    {
      ...
      content: '<h4>Зачем нужен APK</h4>' +
        ...
        '<h4>Установка</h4>' +
        '<p>Скачайте <code>neofit_tv2.apk</code> из админки (ссылка «Загрузить APK» в меню) или скопируйте файл на флешку и установите на приставке через файловый менеджер.</p>' +
        '<h4>Первый запуск</h4>' +
