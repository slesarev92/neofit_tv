  ...
  window.DOCS_SECTIONS = [
    ...
    },
    {
      ...
      content: '<h4>Зачем нужен APK</h4>' +
        ...
        '<h4>Установка</h4>' +
        '<p>Скачайте <code>neofit_tv.apk</code> из админки (ссылка «Загрузить APK» в меню; требуется авторизация) и установите на приставке через файловый менеджер. Рекомендуется устанавливать как обычное приложение (не в системный раздел).</p>' +
