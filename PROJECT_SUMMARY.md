...
| v1.7 | Автобэкап из панели (node-cron); стили чекбоксов. Расписание работы экранов: часы работы, заставка вне часов (загрузка изображения), выпадающий список часовых поясов, «Время перезагрузки плеера». |
...
| 5 | **Уведомления в Telegram** | ⏳ Следующий | Офлайн/онлайн экранов; `telegram.js`, тестовое сообщение в настройках. |
